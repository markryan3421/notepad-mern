...
const NoteCard = ({ note, setNotes }) => {
  ...
  const handleDelete = async (e, id) => {
    ...
    try {
      await api.delete(`/notes/${id}`); // Route, the note to be deleted
      setNotes((prev) => prev.filter(note => note._id !== id)); // Get rid of deleted note from state and update the page
